 ...
 * borders are drawn to create a three-dimensional effect.  The <code>G3DRect</code>
 * class is a subclass of <a href="GRect.html"><code>GRect</code></a>, and therefore
 ...
 * <code>&nbsp;&nbsp;&nbsp;</code>Sets the <code>G3DRect</code> to appear raised
 * or lowered as specified by the parameter</td></tr>
 * <tr><td><code>boolean isRaised()</code><br>
 * <code>&nbsp;&nbsp;&nbsp;</code>Returns <code>true</code> if this <code>G3DRect</code> is raised.</td></tr>
 * </table></td></tr></table>
 ...
 * To use the <code>G3DRect</code> class, the first
 * step is to construct a new <code>G3DRect</code>
 * object and add it to an existing <code>GCanvas</code> (assumed here to be
 * stored in the variable <code>gc</code>), as follows:
 *
 * <p><dd>
 * <code>
 * G3DRect rect = new G3DRect(100, 75, 150, 50);<br>
 * gc.add(rect);<br>
 * </code>
 * </dd><p>
 *
 * This code creates a <code>G3DRect</code> with the specified dimensions
 * and installs the label in the <code>GCanvas</code> as shown in the figure to the right.
 * </td>
 * <td width=230 align=right valign=top>
 * <img src="../../../../images/G3DRectTest1.gif">
 * </td>
 * </tr>
 * </table>
 */
...
/* Inherited method: setFillColor(c) */
/**
 * @inherited GObject#void setFillColor(Color c)
