 ...
 */
	public GRectangle getBounds() {
		...
		return new GRectangle(xMin, yMin, xMax - xMin + 1, yMax - yMin + 1);
	}
 ...
 */
	private void addArc(double x, double y, double width, double height, double start, double sweep) {
