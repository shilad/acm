/*
 * @(#)TableConstraints.java   1.0 06/08/25
 */
 ...
 * <p><dd>
 * <code>
 * new TableConstraints("gridx=2 gridy=3 fill=BOTH");<br>
 * </code>
 * </dd>
 */
 ...
 *
 * <p><code>&nbsp;&nbsp;&nbsp;</code><i>key</i><code>=</code><i>value</i>
 *
 ...
 * example, the string
 *
 * <p><code>&nbsp;&nbsp;&nbsp;"width=20 fill=BOTH"</code>
 *
 ...
 */
	public TableConstraints(Map map) {
		...
		width = constraintTable.getIntOption("width", 0);
		height = constraintTable.getIntOption("height", 0);
